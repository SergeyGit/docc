...
Requests to Tranzzo could be optionally signed, it is recommended. In this case, header `X-API-AUTH` should be replaced with appropriate signing algorithm.
See examples below.

<aside class="notice">
    Signatures are case sensitive, they have to be lowercase <a href="https://en.wikipedia.org/wiki/Hexadecimal">Hex</a>.
</aside>
